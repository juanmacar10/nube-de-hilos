        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-2 mb-6">
                {products.map(product => (
                    <div key={product.id} className="bg-white border border-gray-light rounded-lg p-3 grid grid-cols-[40px_1fr_auto] items-center gap-2">
                        ...
                        <div>
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {product.visible ? <span className="bg-green-100 text-green-800 text-[10px] px-2 py-0.5 rounded-full">visible</span> : <span className="bg-gray-100 text-gray-500 text-[10px] px-2 py-0.5 rounded-full">oculta</span>}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button type="submit" className="bg-gold text-soft-black px-4 py-1.5 rounded-md text-xs font-medium cursor-pointer">
                                {editingId ? 'Actualizar' : 'Guardar'} mochila
                            </button>
                        </div>
